<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 " data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
            <img width="100%" src="../../src/php/admin/light-bootstrap-dashboard-master/examples/images/footer/2.jpg" alt="">
        </div>
        ...
        <div class="row container">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 row align-items-center">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-end">
                    <img width="50%" src="../../src/php/admin/light-bootstrap-dashboard-master/examples/images/footer/momo-tS5.png" alt="">
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-start">
                    <img width="50%" src="../../src/php/admin/light-bootstrap-dashboard-master/examples/images/footer/vnpay-bBZ.png" alt="">
                </div>

                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center">
                    <img width="100%" src="../../src/php/admin/light-bootstrap-dashboard-master/examples/images/footer/bct-5Sz.png" alt="">
                </div>
