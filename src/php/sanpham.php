...
<main>
  ...
  <div class="container-fluid">
    <div class="container d-flex py-5 row">
      <div id="" class="col-6">
        <img width="100%" src="../php/admin/light-bootstrap-dashboard-master/examples/images/product/<?php echo $image; ?>" alt="" />
      </div>
      <div class="col-6">
              ...
              while ($row1 = $result1->fetch_assoc()) {
                echo '<div class="col-6">
                    <div class="sanpham_item text-center">
                      <img width="100"
                        src="../php/admin/light-bootstrap-dashboard-master/examples/images/product/' . $row1['image'] . '";
            ...
            if ($result_nu->num_rows > 0) {
              while ($row_nu = $result_nu->fetch_assoc()) {
                echo '<div class="col-6">
                    <div class="sanpham_item text-center">
                      <img width="100"
                        src="../php/admin/light-bootstrap-dashboard-master/examples/images/product/' . $row_nu['image'] . '";
          ...
          while ($row3 = $result3->fetch_assoc()) {
            echo '<div class="swiper-slide">
                  <div class="product-item">
                    ...
                    <img
                      src="../php/admin/light-bootstrap-dashboard-master/examples/images/product/' . $row3['image'] . '"
                      alt=""
                    />
    ...
    <div class="container pt-4">
      ...
      if (isset($_COOKIE['user'])) {
        ...
        if ($result4->num_rows > 0) {
          ...
          <div class="mb-3">
            <textarea type="text" required name="comment" placeholder="Nhập bình luận của bạn" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></textarea>
          </div>
          ...
          echo '</p>
              ...
              <div class="rep mt-2">
                <form action="" method="post">
                  <textarea name="rep_comment_sp" required width="600px" id="" class="form-control" placeholder="trả lời bình luận của ' . $row8['username'] . '"></textarea>
...
<footer id="footer" class="mt-5 mb-3"></footer>
