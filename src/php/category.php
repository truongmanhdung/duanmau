...
if (isset($_GET['id'])) {
  ...
  <div class="banner" style="background-image: url(../php/admin/light-bootstrap-dashboard-master/examples/images/category/banner/' . $image_banner . ');">
  ...
  echo '<div class="container-fluid">
  <div class="banner" style="background-image: url(../php/admin/light-bootstrap-dashboard-master/examples/images/category/banner/Banner_Mens.webp);">
    <div class="container pt-5">
      <h1 class="text-white pt-5 py-2" style="text-transform: uppercase; 
      ">Tất cả sản phẩm</h1>
    </div>
            ...
            if (isset($_GET['id'])) {
              ...
              if ($top_view->num_rows > 0) {
                while ($row = $top_view->fetch_assoc()) {
                  ...
                  <img width="100%" src="../php/admin/light-bootstrap-dashboard-master/examples/images/product/' . $row['image'] . '" alt="">
                </div>
