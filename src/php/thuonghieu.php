...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="container-fluid">
                ...
                background-position: center center;background-image: url(../php/admin/light-bootstrap-dashboard-master/examples/images/thuonghieu/' . $image . ');">
    ...
    echo '<div class="container-fluid">
    <div class="banner pb-5" style="background-size: cover;
    background-position: center center;background-image: url(../php/admin/light-bootstrap-dashboard-master/examples/images/thuonghieu/Beverly_2.jpg);">
        <div class="container pt-5">
