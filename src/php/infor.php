...
<style>
    .header_top_infor {
        height: 300px;
        background: linear-gradient(270deg, rgba(255, 255, 255, 0) 32.01%, #fff 61.46%), url(../php/admin/light-bootstrap-dashboard-master/examples/images/background-3Ef.png) no-repeat;
            ...
            <div class="information">
                ...
                <div class="user_name">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom">
                            <img width="100px" src="../php/admin/light-bootstrap-dashboard-master/examples/images/user/' . $avatar . '" alt="">
                        ...
                        <div class="hover_form_infor p-5 bg-light">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="d-flex align-items-center text-center justify-content-between">
                                    <img width="100px" src="../php/admin/light-bootstrap-dashboard-master/examples/images/user/' . $avatar . '" alt="">
                                    <img class="mx-4" width="100px" src="../php/admin/light-bootstrap-dashboard-master/examples/images/chuyendoi.png" alt="">
                                    <label for="imgInp">
                                        <img class="" width="100px" src="../php/admin/light-bootstrap-dashboard-master/examples/images/them.png" alt="" id="blah">
                                    </label>
...
if(isset($_POST['update_name'])){
    ...
    if ($_FILES['image']['type'] == "image/jpeg" || $_FILES['image']['type'] == "image/png" || $_FILES['image']['type'] == "image/gif" || $_FILES['image']['type'] == "image/webp") {
        ...
        move_uploaded_file($tmp, "../php/admin/light-bootstrap-dashboard-master/examples/images/user/" . $image);
