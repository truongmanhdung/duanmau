    ...
    <main>
      ...
      ?>
        ...
        if($result_slide ->num_rows > 0){
          $dem = 1;
          while($row_slide = $result_slide->fetch_assoc()){
            echo ' <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="'.$dem.'"></li>';
            $dem++;
          }
        }
      ?>
        ...
        if($result_slide ->num_rows > 0){
          while($row_slide = $result_slide->fetch_assoc()){
            ...
            <div class="carousel-item active">
              <img src="./admin/light-bootstrap-dashboard-master/examples/images/slide/'.$row_slide['image'].'" class="d-block w-100" alt="'.$row_slide['image'].'">
              <div class="carousel-caption d-none d-md-block">
                <h1 class="text-white mb-5">'.$h1.'</h1>
                <h3 class="text-white mb-5">'.$h3.'</h3>
                <p class="mb-5">'.$slogan.'</p>
                <a href="'.$link.'" data-aos="fade-down"
                ...
                while($row = $result->fetch_assoc()){
                  ...
                  <a href="category.php?id='.$row['id_category'].'">
                    <div class="category_item">
                      <img src="./admin/light-bootstrap-dashboard-master/examples/images/category/'.$row['image'].'" alt="" />
